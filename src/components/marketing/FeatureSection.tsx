...
/* Small CSS "mock UI" illustrations that sit on top of each feature card. */

function AnythingArt() {
  return (
    <div className="flex h-32 items-center justify-center rounded-xl bg-muted/60">
...
function ShareArt() {
  return (
    <div className="relative flex h-32 items-center justify-center rounded-xl bg-muted/60">
    ...
    <section className="relative z-10 mx-auto max-w-7xl px-6 py-16">
      <div className="mb-12 text-center">
        <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">
          Your world. <span className="text-galli">Your rules.</span>
        </h2>
        <p className="mt-3 text-muted-foreground">
          Everything you need to create, interact and share.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {FEATURES.map((feature) => (
          <div
            key={feature.title}
            className="rounded-2xl border border-border bg-surface p-4 shadow-soft transition hover:shadow-soft-lg"
          >
            <feature.art />
