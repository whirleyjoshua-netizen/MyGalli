...
describe('HubViewer', () => {
  it('renders root items', () => {
    render(<HubViewer hub={hub} folders={folders} items={items} notes={[]} bookmarks={[]} username="alice" hubId="hub1" />)
...
describe('HubViewer locked nodes', () => {
  ...
  it('renders a lock affordance for a locked folder', () => {
    render(<HubViewer hub={hub} folders={lockedFolders} items={lockedItems} notes={[]} bookmarks={[]} username="alice" hubId="hub1" />)
